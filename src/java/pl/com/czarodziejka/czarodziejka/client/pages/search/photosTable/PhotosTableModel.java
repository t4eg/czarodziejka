...
import pl.com.czarodziejka.czarodziejka.client.pages.search.photosTable.photoFrame.Frame;
...
public class PhotosTableModel {
    ...
    private final PhotosTableView view;
    ...
    public PhotosTableModel(PhotosTableView view, boolean showForWho) {
        this.view = view;
